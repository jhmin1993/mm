...
<div class="card-grid" markdown="0">
  <div class="card card-config">
    <h4><a href="{{ '/config-guide/master-data/' | relative_url }}">기준 정보 설정</a></h4>
    <p>자재 유형, 평가 클래스, 조직 구조</p>
  </div>
  <div class="card card-config">
    <h4><a href="{{ '/config-guide/purchasing/' | relative_url }}">구매 설정</a></h4>
    <p>문서 유형, 번호 범위, 승인 절차, 가격 조건</p>
  </div>
  <div class="card card-config">
    <h4><a href="{{ '/config-guide/inventory/' | relative_url }}">재고관리 설정</a></h4>
    <p>Movement Type, 재고 유형, 실사</p>
  </div>
  <div class="card card-config">
    <h4><a href="{{ '/config-guide/invoice/' | relative_url }}">송장 검증 설정</a></h4>
    <p>허용 오차, 자동 계정, 세금 코드</p>
  </div>
</div>
